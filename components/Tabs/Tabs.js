class TabLink {
  ...
  selectTab(){
    ...
    /**this.cards refers to ONLY the cards linked to the tab we clicked.
     * Ergo, only the cards linked to the tab we clicked will have this event triggered, 
     * and only those specifc cards will be set to display = "flex"
     */
