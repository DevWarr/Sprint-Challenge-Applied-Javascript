class Carousel {
    constructor(carousel) {
        ...
        // Each event listener(extra event on page load to display initial image)
        window.addEventListener("load", () => sildeRightIn(this.displayImg));
        this.leftBtn.addEventListener("click", () => clickLeft())
        this.rightBtn.addEventListener("click", () => clickRight())
    }
    clickLeft() {
